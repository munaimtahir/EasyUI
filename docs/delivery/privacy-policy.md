...
## Information not collected by EasyUI

Based on the current app build, EasyUI does not:

- require an account
- run its own cloud sync service
- send your personal data to an EasyUI backend
- include ads
...
The current repository does not include third-party analytics, advertising, or crash-reporting services.

## Your choices

You can remove local EasyUI data by uninstalling the app or clearing app storage through Android settings.
