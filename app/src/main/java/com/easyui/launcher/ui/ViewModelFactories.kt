    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T =
        when {
            ...
            modelClass.isAssignableFrom(CaregiverViewModel::class.java) ->
                CaregiverViewModel(container) as T
            modelClass.isAssignableFrom(RemoteLinkViewModel::class.java) ->
                RemoteLinkViewModel(container) as T
            modelClass.isAssignableFrom(BackupViewModel::class.java) ->
 BackupViewModel(container) as T
