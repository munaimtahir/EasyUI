...
| A3 | 00_static | Permission declaration audit | P2 | PASS | screenshots/a3.png | Manifest declares only the currently expected call, SMS, and optional flash capabilities for this build. |
...
| B6 | 50_caregiver | Caregiver entry and protection | P1 | PASS | screenshots/b6.png | Hidden caregiver entry was reachable through the status-bar long press or its clock fallback. |
| B7 | 60_layout_and_visibility | Layout stability and hidden apps | P1 | BLOCKED | screenshots/b7.png | Home was not reachable, so hidden-app verification is blocked. |
| B8 | 70_accessibility_and_display | Accessibility and display resilience | P2 | BLOCKED | screenshots/b8.png | Home was not reachable after changing font scale, so accessibility review is blocked. |
