...
| B7 | 60_layout_and_visibility | Layout stability and hidden apps | P1 | BLOCKED | screenshots/b7.png | Caregiver entry could not be opened, so hidden-app verification is blocked. |
| B8 | 70_accessibility_and_display | Accessibility and display resilience | P2 | PARTIALLY_VERIFIED | screenshots/b8.png | Font scale was raised to 1.3 and the core home labels remained present in the UI dump. Visual clipping still requires human review of the captured screenshot. |
